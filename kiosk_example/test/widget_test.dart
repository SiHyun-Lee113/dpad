...
import 'package:kiosk_example/menu_page.dart';
...
void main() {
  ...
  testWidgets('right from the 4th menu lands on the 5th, then wraps last → first',
      (tester) async {
    ...
    expect(FocusManager.instance.primaryFocus?.debugLabel, '녹차라떼',
        reason: '4×2 그리드에서 4번 우 키는 다음 줄 5번으로 가야 함');
